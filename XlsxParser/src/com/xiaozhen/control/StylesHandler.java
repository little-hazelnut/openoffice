...
import com.xiaozhen.style.Alignment.Horizontal;
import com.xiaozhen.style.Alignment.ReadingOrder;
import com.xiaozhen.style.Alignment.Vertical;
import com.xiaozhen.style.Border;
import com.xiaozhen.style.Border.BorderStyle;
import com.xiaozhen.style.Alignment;
import com.xiaozhen.style.CellXf;
import com.xiaozhen.style.ColorStyle;
import com.xiaozhen.style.Fill;
import com.xiaozhen.style.GradientFillEffects;
import com.xiaozhen.style.Stop;
import com.xiaozhen.style.Fill.PatternType;
import com.xiaozhen.style.Font;
import com.xiaozhen.style.Font.Font_u;
import com.xiaozhen.style.Font.VertAlign;
import com.xiaozhen.style.GradientFillEffects.GradientType;
import com.xiaozhen.style.NumFmt;
import com.xiaozhen.style.Styles;
...
public class StylesHandler extends DefaultHandler {
	...
	private boolean startBorderTag = false;
	...
	public void endElement(String uri, String localName, String qName)
			throws SAXException {
		if (qName.equals(TAG_numFmt)) {// numFmt
			numFmts.add(numFmt);
		} else if (qName.equals(TAG_numFmts)) {// numFmts
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName.equals(TAG_numFmts)) {// 解析numFmts标签
			numFmts = new ArrayList<NumFmt>();
		} else if (qName.equals(TAG_numFmt)) {// 解析numFmt标签
			numFmt = new NumFmt();
			numFmt.setFormatCode(attributes.getValue(QNAME_formatCode));
			numFmt.setNumFmtId(Integer.parseInt(attributes
			...
			if ((attriValue = attributes.getValue(QNAME_theme)) != null) {// theme
				...
				if ((attriValue = attributes.getValue(QNAME_tint)) != null) {
			...
			String attriValue = attributes.getValue(QNAME_val);
			...
			String attriValue = attributes.getValue(QNAME_patternType);
		...
		} else if (startBorderTag && qName.equals(TAG_color)) {// border->color
			colorStyle = parseColorStyle(attributes);
		} else if (qName.equals(TAG_cellXfs)) {// cellXfs
